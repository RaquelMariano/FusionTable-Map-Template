(function (window, undefined) {
    ...
    MapsLib.prototype.doSearch = function () {
       ...
       // self.whereClause += " AND " + searchType.slice(0, searchType.length - 1) + ")";
        ...
        var type_column = "'Main Technology'";
        var tempWhereClause = [];
        if ( $("#cbType1").is(':checked')) tempWhereClause.push('DSF');
        if ( $("#cbType2").is(':checked')) tempWhereClause.push('Openings');
        if ( $("#cbType3").is(':checked')) tempWhereClause.push('Shading System');
        if ( $("#cbType4").is(':checked')) tempWhereClause.push('Smart Material');
        if ( $("#cbType5").is(':checked')) tempWhereClause.push('Kinetic Building');
